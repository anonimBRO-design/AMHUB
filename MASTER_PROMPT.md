...
\- If a component already exists, extend it only where information is missing.

\- If there is any conflict, follow the Product Specification first, then the Design System.
