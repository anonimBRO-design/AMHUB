  ...
  (
    ...
    return (
      <div className="flex w-full flex-col gap-1.5">
        {label && (
          <label htmlFor={inputId} className="text-[var(--font-size-label-md)] font-medium text-[var(--color-text-secondary)]">
            {label}
        ...
        <div className="relative flex items-center">
          ...
          {prefix && (
            <span className="absolute left-3 text-[var(--color-text-tertiary)]">{prefix}</span>
          )}
          <input
            id={inputId}
            type={type}
          ...
          {suffix && (
            <span className="absolute right-3 text-[var(--color-text-tertiary)]">{suffix}</span>
          )}
        </div>
