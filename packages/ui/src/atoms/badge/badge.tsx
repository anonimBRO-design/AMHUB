...
const styleMap: Record<string, Record<string, string>> = {
	category: {
		...
		"jj melar": "bg-amber-500 text-white shadow-sm",
		"jj-belah": "bg-cyan-500 text-white shadow-sm",
		"jj belah": "bg-cyan-500 text-white shadow-sm",
		...
		"jj-abstract": "bg-sky-500 text-white shadow-sm",
		"jj abstract": "bg-sky-500 text-white shadow-sm",
	...
	rarity: {
		common:
			"bg-slate-500/20 text-slate-800 dark:text-slate-300 border border-slate-500/30",
		rare: "bg-blue-500/20 text-blue-800 dark:text-blue-300 border border-blue-500/30",
		epic: "bg-cyan-500/20 text-cyan-900 dark:text-cyan-300 border border-cyan-500/30",
		legendary:
