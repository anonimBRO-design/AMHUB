...
export type FontFamilyToken = "display" | "body" | "mono" | "sans";
...
export const tokens: DesignTokens = {
	...
	shadow: {
		...
		"card-hover":
			"0 8px 32px rgba(0, 0, 0, 0.5), 0 0 24px rgba(0, 200, 255, 0.2)",
		modal: "0 24px 64px rgba(0, 0, 0, 0.7), 0 0 48px rgba(0, 0, 0, 0.3)",
		dropdown: "0 8px 24px rgba(0, 0, 0, 0.5)",
		"glow-xs": "0 0 8px rgba(0, 200, 255, 0.15)",
		"glow-sm": "0 0 16px rgba(0, 200, 255, 0.2)",
		"glow-md": "0 0 32px rgba(0, 200, 255, 0.3)",
		"glow-lg": "0 0 56px rgba(0, 200, 255, 0.4)",
		focus: "0 0 0 3px rgba(0, 200, 255, 0.5)",
