...
export async function getCollectionById(
  ...
  if (error) throw error;
  assertExists(collection, "Collection was not found.");
...
export async function getCollectionOwner(client: DalClient, id: string) {
  ...
  return assertExists(existing, "Collection was not found.");
}
