	...
	return (
		...
		>
			<button
				...
				className={`flex items-center gap-1.5 rounded-2xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 cursor-pointer ${
					variant === "compact"
			...
			<AnimatePresence>
				{isOpen && (
					<motion.div
						...
						className={`absolute right-0 w-44 z-50 py-1.5 rounded-2xl bg-[#0e0d14]/95 border border-white/15 backdrop-blur-2xl shadow-[0_10px_30px_rgba(0,0,0,0.8),0_0_20px_rgba(0,200,255,0.15)] focus:outline-none overflow-hidden ${
